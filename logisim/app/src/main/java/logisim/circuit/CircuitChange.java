...
class CircuitChange {
	...
	public static CircuitChange set(Circuit circuit, Component comp, Attribute<?> attr, Object oldValue,
			Object newValue) {
	...
	private CircuitChange(Circuit circuit, int type, Component comp, Attribute<?> attr, Object oldValue,
			Object newValue) {
	...
	CircuitChange getReverseChange() {
		return switch (type) {
			case CLEAR, REMOVE_ALL -> CircuitChange.addAll(circuit, comps);
