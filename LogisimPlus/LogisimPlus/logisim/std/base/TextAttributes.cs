...
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRIBUTES = java.util.Arrays.asList(new logisim.data.Attribute<?>[] { Text.ATTR_TEXT, Text.ATTR_FONT, Text.ATTR_HALIGN, Text.ATTR_VALIGN });
		private static readonly List<Attribute> ATTRIBUTES = new List<Attribute> {Text.ATTR_TEXT, Text.ATTR_FONT, Text.ATTR_HALIGN, Text.ATTR_VALIGN};
		...
		public TextAttributes()
		{
			...
			halign = (AttributeOption)logisim.std.@base.Text.ATTR_HALIGN.parse("center");
			valign = (AttributeOption)logisim.std.@base.Text.ATTR_VALIGN.parse("base");
			offsetBounds = null;
		}
