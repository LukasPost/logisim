...
namespace draw.shapes
{
	...
	public class DrawAttr
	{
		...
		public static readonly Attribute<Font> FONT = Attributes.forFont("font", Strings.getter("attrFont"));
		public static readonly Attribute<AttributeOption> ALIGNMENT = Attributes.forOption("align", Strings.getter("attrAlign"), new AttributeOption[] {ALIGN_LEFT, ALIGN_CENTER, ALIGN_RIGHT});
		public static readonly Attribute<AttributeOption> PAINT_TYPE = Attributes.forOption("paintType", Strings.getter("attrPaint"), new AttributeOption[] {PAINT_STROKE, PAINT_FILL, PAINT_STROKE_FILL});
		public static readonly Attribute<int> STROKE_WIDTH = Attributes.forIntegerRange("stroke-width", Strings.getter("attrStrokeWidth"), 1, 8);
		public static readonly Attribute<Color> STROKE_COLOR = Attributes.forColor("stroke", Strings.getter("attrStroke"));
		public static readonly Attribute<Color> FILL_COLOR = Attributes.forColor("fill", Strings.getter("attrFill"));
		public static readonly Attribute<Color> TEXT_DEFAULT_FILL = Attributes.forColor("fill", Strings.getter("attrFill"));
		public static readonly Attribute<int> CORNER_RADIUS = Attributes.forIntegerRange("rx", Strings.getter("attrRx"), 1, 1000);
...
// ORIGINAL LINE: public static final java.util.List<logisim.data.Attribute<?>> ATTRS_TEXT = createAttributes(new logisim.data.Attribute[] { FONT, ALIGNMENT, FILL_COLOR });
		public static readonly IList<Attribute<object>> ATTRS_TEXT = createAttributes(new Attribute[] {FONT, ALIGNMENT, FILL_COLOR});
// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: public static final java.util.List<logisim.data.Attribute<?>> ATTRS_TEXT_TOOL = createAttributes(new logisim.data.Attribute[] { FONT, ALIGNMENT, TEXT_DEFAULT_FILL });
		public static readonly IList<Attribute<object>> ATTRS_TEXT_TOOL = createAttributes(new Attribute[] {FONT, ALIGNMENT, TEXT_DEFAULT_FILL});
// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: public static final java.util.List<logisim.data.Attribute<?>> ATTRS_STROKE = createAttributes(new logisim.data.Attribute[] { STROKE_WIDTH, STROKE_COLOR });
		public static readonly IList<Attribute<object>> ATTRS_STROKE = createAttributes(new Attribute[] {STROKE_WIDTH, STROKE_COLOR});
...
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRS_FILL_STROKE = createAttributes(new logisim.data.Attribute[] { PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR });
		private static readonly IList<Attribute<object>> ATTRS_FILL_STROKE = createAttributes(new Attribute[] {PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR});
// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRS_FILL_FILL = createAttributes(new logisim.data.Attribute[] { PAINT_TYPE, FILL_COLOR });
		private static readonly IList<Attribute<object>> ATTRS_FILL_FILL = createAttributes(new Attribute[] {PAINT_TYPE, FILL_COLOR});
// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRS_FILL_BOTH = createAttributes(new logisim.data.Attribute[] { PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR, FILL_COLOR });
		private static readonly IList<Attribute<object>> ATTRS_FILL_BOTH = createAttributes(new Attribute[] {PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR, FILL_COLOR});
...
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRS_RRECT_STROKE = createAttributes(new logisim.data.Attribute[] { PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR, CORNER_RADIUS });
		private static readonly IList<Attribute<object>> ATTRS_RRECT_STROKE = createAttributes(new Attribute[] {PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR, CORNER_RADIUS});
// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRS_RRECT_FILL = createAttributes(new logisim.data.Attribute[] { PAINT_TYPE, FILL_COLOR, CORNER_RADIUS });
		private static readonly IList<Attribute<object>> ATTRS_RRECT_FILL = createAttributes(new Attribute[] {PAINT_TYPE, FILL_COLOR, CORNER_RADIUS});
// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: private static final java.util.List<logisim.data.Attribute<?>> ATTRS_RRECT_BOTH = createAttributes(new logisim.data.Attribute[] { PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR, FILL_COLOR, CORNER_RADIUS });
		private static readonly IList<Attribute<object>> ATTRS_RRECT_BOTH = createAttributes(new Attribute[] {PAINT_TYPE, STROKE_WIDTH, STROKE_COLOR, FILL_COLOR, CORNER_RADIUS});

// JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in C#:
// ORIGINAL LINE: private static java.util.List<logisim.data.Attribute<?>> createAttributes(logisim.data.Attribute<?>[] values)
		private static IList<Attribute<object>> createAttributes<T1>(Attribute<T1>[] values)
		{
...
// ORIGINAL LINE: public static java.util.List<logisim.data.Attribute<?>> getFillAttributes(logisim.data.AttributeOption paint)
		public static IList<Attribute<object>> getFillAttributes(AttributeOption paint)
		{
...
// ORIGINAL LINE: public static java.util.List<logisim.data.Attribute<?>> getRoundRectAttributes(logisim.data.AttributeOption paint)
		public static IList<Attribute<object>> getRoundRectAttributes(AttributeOption paint)
		{
			if (paint == PAINT_STROKE)
			{
